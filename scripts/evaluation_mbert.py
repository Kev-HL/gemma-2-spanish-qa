"""
Script for evaluating an extractive QA model, with optional W&B integration.
Configurable via a JSON file that adheres to the schema in
configs/schemas/eval_mbert.json.
...
Example usage:
    python scripts/evaluation_mbert.py configs/eval/test_mbert.json
"""
...
log_file = log_dir / f"evaluation_mbert_{timestamp}.log"
...
def main(config_path: str) -> None:
    logger.info("Starting mBERT evaluation script")
    # ============================ SETUP =======================================
    ...
    logger.info(f"Loading mBERT from directory: {cfg['model']['model_name_or_path']}")
